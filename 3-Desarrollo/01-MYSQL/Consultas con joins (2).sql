...
select nombre_plan,nombre,apellidos
from plan inner join  usuario on plan.id_plan=usuario.id_plan;

-- 4.Nombres y apellidos de los clientes que adquirieron pla npremium
select nombre_plan,nombre,apellidos,id_plan
from plan inner join  usuario on plan.id_plan=usuario.fkid_plan
where id_plan = 3;
