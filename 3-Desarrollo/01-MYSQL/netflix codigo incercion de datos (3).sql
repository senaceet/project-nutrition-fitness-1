...
insert into documentoadministrador (id_tipo_documento, desc_doc , nombre_documento)
 ...
 -- datos tabla plan
 insert into plan (id_plan, nombre_plan , precio_mensual, duranciol_plan,cantidad_perfiles)
 values (1,'basico', 19900,'30dias',1),
 (2,'estandar',24900,'30dias',2),
 (3,'premium',32900,'30dias',4);
 
 -- datos usuario
 insert into usuario (numero_documento, nombre, apellidos, email, contraseña, id_tipo_documento, fkid_rol, fkid_plan)
 ...
 ('1192925073', 'Yuber Andres', 'Espinosa Guaneme', 'yaespinosa370@misena.edu.co', 'andres320', 1, 2, 3),
 ('1001201058','Sergio', 'Muñoz Rincon','sergitomuri19@gmail.com','serjssjshs', 2,1,3 ),
 ...
 ('5641235432',' Karol Juliana','Acuña Lopez','karollopezacu@gmail.com','4654fds',1,2,3),
 ('1220642319','Eduardo Alfonso','Alvaro Pacheco','Eduardopapa@gmail.com','jk456jn4',3,2,1),
 ('1000545652',' Ingrid Lorena','Arenalez Lopez','ingridarenalez@gmail.com','4hj65k4',2,2,3),
 ('1000856245','Julian Ferley','Barajas Gomez','barajasferley@gmail.com','456431',3,2,2),
 ('1230215321','Veyker Aldair','Barreto Ruz','beykerarlin@gmail.com','4gf65465',2,2,1),
 ('1231546213',' Karen Dayana','Basto Pico','picodayana@gmail.com','ds65f4gs',1,2,2),
...
-- datos tabla perfil
insert into perfil(id_perfil ,nombre ,imagen ,id_plan,id_tipo_idioma ,id_categoria) 
values(1,'Daniel Esteban Martinez Naranjo',load_file('C:\Users\Public\Pictures\1'),3,1,1),
 (2,'johan nabuzaradan campos forero',load_file('C:\Users\Public\Pictures\2'),3,1,2),
 (3,'Yuber Andres Espinosa Guaneme',load_file('C:\Users\Public\Pictures\3'), 3,3,5),
 (4,'Sergio Muñoz Rincon',load_file('C:\Users\Public\Pictures\4'),3 ,2,7),
 (5,'jhon edier gonzalez urrego',load_file('C:\Users\Public\Pictures\5'),2,3,6),
 (6,'juan david solo guitierres',load_file('C:\Users\Public\Pictures\6'),2,3,4),
 (7,'daniel felipe vargas guzman',load_file('C:\Users\Public\Pictures\7'),2,3,1),
(8,'felipe Esteban Molina Perez',load_file('C:\Users\Public\Pictures\8'),1,1,2),
 (9,' Karol Juliana Acuña Lopez',load_file('C:\Users\Public\Pictures\9'),3,1,3),
 (10,'Eduardo Alfonso Alvaro Pacheco',load_file('C:\Users\Public\Pictures\10'),1,2,6),
 (11,' Ingrid Lorena Arenalez Lopez',load_file('C:\Users\Public\Pictures\11'),3,2,4),
 (12,'Julian Ferley Barajas Gomez',load_file('C:\Users\Public\Pictures\12'),2,3,2),
 (13,'Veyker Aldair Barreto Ruz',load_file('C:\Users\Public\Pictures\13'),1,1,7),
 (14,' Karen Dayana Basto Pico',load_file('C:\Users\Public\Pictures\14'),2,3,1),
 (15,' Karen Yuliana Bermudez Delgado',load_file('C:\Users\Public\Pictures\15'),3,3,1),
 (16,'Daniel Esteba Buitrago Lozano',load_file('C:\Users\Public\Pictures\16'),3,2,3),
 (17,'Silvia Juliana Caceres Peralta',load_file('C:\Users\Public\Pictures\17'),2,1,2),
 (18,' Karol Daniela Corredor Duran ',load_file('C:\Users\Public\Pictures\18'),1,1,4),
 (19,'Yohana Delgado Contreras',load_file('C:\Users\Public\Pictures\19'),2,2,6),
(20,' Angel David Delgado Sarmiento',load_file('C:\Users\Public\Pictures\20'),1,2,7);
